...
class ExSendDBImg extends StatefulWidget {
  const ExSendDBImg({super.key});

  @override
  State<ExSendDBImg> createState() => _Ex09imageState();
}
...
class _Ex09imageState extends State<ExSendDBImg> {
  @override
    ...
    return Scaffold(
        body: Container(
            ...
            child: Column(children: [
              ...
              Container( //Image.file(File(pick_image!.path,))
                  margin: EdgeInsets.all(10),
                  //단독으로 띄우기
                  child: ImgContainer()
  ...
  void oneImgSend() async{
    ...
    String url = "http://211.105.164.253:8085/imgDb/insertImg";
    ...
    FormData data = FormData.fromMap(
        {
          ...
          //MultipartFile.fromFile(이미지 경로) 사용하여 파일의 경로를 전송
